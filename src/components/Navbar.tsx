    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <a href="#home" className="flex items-center space-x-3 group">
          <div className="w-12 h-12 rounded-full border border-white/10 bg-white/5 flex items-center justify-center overflow-hidden group-hover:border-electric-blue/40 group-hover:scale-105 group-hover:shadow-lg group-hover:shadow-electric-blue/10 transition-all duration-300 relative p-1.5">
            <Image
              src="/images/logo.png"
              alt="aathi.dev logo"
              width={48}
