...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const messageText = `Hi Athira,

I found your portfolio and would like to discuss a web development project.
...
${formData.message}`;
    ...
    // Open WhatsApp IMMEDIATELY to bypass popup blockers
    const newWindow = window.open(whatsappUrl, "_blank", "noopener,noreferrer");
    if (!newWindow || newWindow.closed || typeof newWindow.closed === "undefined") {
      // Fallback: Redirect if popup blocker is active
